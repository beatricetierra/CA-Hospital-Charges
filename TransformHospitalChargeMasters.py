...
# 2. Read excel sheets given in df
global df
df = pd.DataFrame()
...
# 3. Clean up CPT column
## Ex. ranges => CPT Code 97161-9763 -> 97161, 97162, 97163
## Ex. splits => CPT Code 81002 or 81003 
df_range = extract_cpt_range()
df_split = extract_cpt_split()
df_int = extract_cpt_int()
